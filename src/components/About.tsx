...
export const About: FunctionComponent = () =>  {
  ...
  return (
    <div>
      ...
      <h2>Current Stats</h2>
      <ul>
        <li>DB Size: {dataStats.size}</li>
        <li>Lists: {dataStats.blocklists}</li>
        <li>List Versions: {dataStats.versions.toLocaleString('en-US')}</li>
        <li>Unique Domains: {dataStats.domains.toLocaleString('en-US')}</li>
        <li>Entries across all list versions: {dataStats.entries.toLocaleString('en-US')}</li>
      </ul>
    </div>
