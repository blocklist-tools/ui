...
export const Footer: FunctionComponent = () =>  {
    return (
        <footer className={'component-footer'}>
          <p>
            This has been a fun project, currently it has over 17 million unique and valid domain names. Those unique domains
            are spread across 60,000 unique list versions with a total of 5.8 billion entries.
            ...
            to save the entire list. New versions are added daily and currently only uses 21 GB. You might be curious where
            I got 60,000 unique versions from. The majority of these lists are served on Github, so it was just a simple matter
